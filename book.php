...
<html>
    <head>
        ...
        <!--swiper css link-->
        <link rel="stylesheet" 
        href="href=https://unpkg.com/swiper@8/swiper-bundle.min.css"/>
   ...
   <div class="headings" style="background:url(book.jpg) no-repeat">
    <h1>Book</h1>
   </div>
   ...
   <div class="flex">
    ...
    <div class="inputbox">
        <span>How many?:</span>
        <input type="text" placeholder="enter no of ppl" name="guests">
    </div>
